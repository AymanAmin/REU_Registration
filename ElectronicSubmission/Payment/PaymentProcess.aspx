            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <aside class="col-sm-6">
                        ...
                        <!--<p>Payment form1</p>-->
                        <article class="card" id="paymentWidgets" dir="ltr" style="border: 1px solid gray; border-radius: 10px; padding: 5%;display:none;"> 
                            <form ID="Payment_Form" class="paymentWidgets" runat="server" data-brands="VISA MASTER MADA"></form>
                        </article>
