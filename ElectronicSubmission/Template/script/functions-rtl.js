  ...
  //***************************
    ...
    jQuery(".wm_widget_navlist ul").niceScroll("",{
      ...
      autohidemode: false,
          ...
          cursorborder: 0,
          touchbehavior:true,
          railoffset:   {top: 23, right: -332, left: 0, },
          railpadding:  { top: 0, left: 0, right: 0, bottom: 44, },
    });
...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(24.669441, 46.729127), // New York
