                            ...
                            <div class="card-block" id="SubmittingForm" runat="server">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <asp:RequiredFieldValidator ID="StudentPhoneValidator" runat="server" ForeColor="Red" ErrorMessage="RequiredFieldValidator" Text="Enter Student Phone (12 Number)" ValidationGroup="valFormGroup" ControlToValidate="StudentPhone" ValidationExpression = "^[\s\S]{0,10}$"   Display="Dynamic" CssClass="col-form-label" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label><% = ElectronicSubmission.FieldNames.getFieldName("StudentInfo-SpecializationSecondDesire", "Specialization Second Desire") %><i class="icofont icofont-star-alt-1 text-danger"></i></label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="icofont icofont-safety"></i></span>
                                            <asp:DropDownList ID="Specialization_ID2" class="form-control" runat="server">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
