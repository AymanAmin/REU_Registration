...
namespace ElectronicSubmission
{
    ...
    public partial class StudentSubmitting : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Redirect to closed Submiting form
                ...
                if (ToCheckPercent)
                {
                    ...
                    else
                    {
                        ...
                        if (langId == 1)
                            ...
                            Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "AlertNotify('You have already applied', 'There is a pre-submission matched to this Nationality ID', 'error');", true);
        ...
        public void translateValidationArabic()
        {
            ...
            CompareValidator1.Text = "يجب ان يكون رقم ";
