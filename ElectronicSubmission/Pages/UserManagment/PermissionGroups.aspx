<%@ Page Title="" Language="C#" MasterPageFile="~/MasterEn.Master" AutoEventWireup="true" CodeBehind="PermissionGroups.aspx.cs" Inherits="ElectronicSubmission.Pages.Setting.UserManagment.PermissionGroups" %>

<%@ Register Assembly="DevExpress.Web.v17.2, Version=17.2.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title><% = ElectronicSubmission.FieldNames.getFieldName("PermissionGroups-Title", "User Management - Groups") %></title>
</asp:Content>
        ...
        <div class="card ScrollStyle ">
            ...
            <div class="card-block">
                ...
                <div class="row col-sm-12">
                                ...
                                <div class="card m-t-15">
                                    <div class="auth-box card-block">
                                        <div class="row m-b-20">
                                            <div class="col-md-12">
                                                <h3 class="text-center txt-primary"><% = ElectronicSubmission.FieldNames.getFieldName("PermissionGroups-AddGroup", "Add Group") %></h3>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 ">
                    ...
                    <div class="form-group col-sm-12" style="text-align: right; margin-top: -2%">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-model"><% = ElectronicSubmission.FieldNames.getFieldName("PermissionGroups-AddGroup", "Add Group") %></button>
                    </div>
                    <div class="form-group col-sm-12 blockquote">
                        ...
                        <asp:EntityDataSource ID="GroupDataSource" runat="server" ConnectionString="name=REU_RegistrationEntities" DefaultContainerName="REU_RegistrationEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="Groups" EntityTypeFilter="Group">
                        </asp:EntityDataSource>
                    </div>
                    <hr />
                    <div class="form-group col-sm-6 j-unit" style="margin-top: 0%">
                        <label class="j-label"><% = ElectronicSubmission.FieldNames.getFieldName("PermissionGroups-Groups", "Groups") %></label>
                        <div class="input-group">
