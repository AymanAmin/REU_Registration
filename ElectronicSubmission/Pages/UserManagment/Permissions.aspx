<%@ Page Title="" Language="C#" MasterPageFile="~/MasterEn.Master" AutoEventWireup="true" CodeBehind="Permissions.aspx.cs" Inherits="ElectronicSubmission.Pages.Setting.UserManagment.Permissions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title><% = ElectronicSubmission.FieldNames.getFieldName("Permissions-Title", "User Management - Permission") %></title>
</asp:Content>
        ...
        <div class="card ScrollStyle">
            ...
            <div class="card-block">
                <div class="row col-sm-12">
                                ...
                                <div class="card m-t-15">
                                    <div class="auth-box card-block">
                                        <div class="row m-b-20">
                                            <div class="col-md-12">
                                                <h3 class="text-center txt-primary"><% = ElectronicSubmission.FieldNames.getFieldName("Permissions-AddPermission", "Add Permission") %></h3>
                                            </div>
                                        </div>
                                        <div class="row col-sm-12">
                                            <div class="form-group col-sm-6 j-unit">
                                                <label class="j-label"><% = ElectronicSubmission.FieldNames.getFieldName("Permissions-NameArabic", "Name Arabic") %></label>
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="basic-addon1"><i class="icofont icofont-underline"></i></span>
                                                    <asp:TextBox ID="txtPermission_Name" runat="server" class="form-control"  TextMode="SingleLine"></asp:TextBox>
                                                </div>
                                            ...
                                            <div class="form-group col-sm-6 j-unit">
                                                <label class="j-label"><% = ElectronicSubmission.FieldNames.getFieldName("Permissions-NameEnglish", "Name English") %></label>
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="basic-addon2"><i class="icofont icofont-underline"></i></span>
                                                    <asp:TextBox ID="txtPermission_Name_En" runat="server" class="form-control" ></asp:TextBox>
                                                </div>
                                                <div class="col-sm-12" style="margin-top: -5%">
                                            ...
                                            <div class="form-group col-sm-6 j-unit">
                                                <label class="j-label"><% = ElectronicSubmission.FieldNames.getFieldName("Permissions-ParentForm", "Parent Form") %></label>
                                                <div class="input-group">
                    ...
                    <div class="form-group col-sm-12" style="text-align: right; margin-top: -2%">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-model"><% = ElectronicSubmission.FieldNames.getFieldName("Permissions-AddPermission", "Add Permission") %></button>
                    </div>
