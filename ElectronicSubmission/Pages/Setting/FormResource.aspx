<%@ Page Title="" Language="C#" MasterPageFile="~/MasterEn.Master" AutoEventWireup="true" CodeBehind="FormResource.aspx.cs" Inherits="ElectronicSubmission.Pages.Setting.FormResource" %>

<%@ Register Assembly="DevExpress.Web.v17.2, Version=17.2.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title><% = ElectronicSubmission.FieldNames.getFieldName("FormResource-Title", "REU - Resource") %></title>
</asp:Content>
            ...
            <div class="card-block">
                ...
                <div class="row col-sm-12">
                                ...
                                <div class="card m-t-15">
                                    <div class="auth-box card-block">
                                        <div class="row m-b-20">
                                            <div class="col-md-12">
                                                <h3 class="text-center txt-primary"><% = ElectronicSubmission.FieldNames.getFieldName("FormResource-AddResource", "Add Resource") %></h3>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 ">
                                            <div class="form-group col-sm-12 j-unit" style="margin-top: 5%">
                                                ...
                                                <div class="col-sm-12" style="">
                                                    <asp:RequiredFieldValidator ID="RFVtxtResource_Name" runat="server" ForeColor="Red" ErrorMessage="RequiredFieldValidator" Text="Enter Arabic Name" ValidationGroup="Resource" ControlToValidate="txtResource_Name" Display="Dynamic"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                    ...
                    <div class="form-group col-sm-12 <%= ElectronicSubmission.FieldNames.getTextRTL() %>" style="margin-top: -2%">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-model"><% = ElectronicSubmission.FieldNames.getFieldName("FormResource-AddResource", "Add Resource") %></button>
                    </div>
                    <div class="form-group col-sm-12 blockquote">
                        <div class="dt-responsive table-responsive">
                            <dx:ASPxGridView ID="ResourceGridView" Style="width: 100%; text-align: center; margin-top: 0%" runat="server" AutoGenerateColumns="False" DataSourceID="ResourceDataSource" KeyFieldName="ResourceID" Theme="Mulberry">
                                <Settings />
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn FieldName="ResourceID" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="0" Caption="ID">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <CellStyle HorizontalAlign="Center">
                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Resource_Name_Ar" ShowInCustomizationForm="True" VisibleIndex="1" Caption="Arabic Name">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <CellStyle HorizontalAlign="Center">
                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="English Name" FieldName="Resource_Name_En" Name="English Name" VisibleIndex="2">
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                            </dx:ASPxGridView>
                        </div>
                        <asp:EntityDataSource ID="ResourceDataSource" runat="server" ConnectionString="name=REU_RegistrationEntities" DefaultContainerName="REU_RegistrationEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="Resources">
