<%@ Page Title="" Language="C#" MasterPageFile="~/MasterEn.Master" AutoEventWireup="true" CodeBehind="LogFile.aspx.cs" Inherits="ElectronicSubmission.Pages.Admin.LogFile" %>

<%@ Register Assembly="DevExpress.Web.v17.2, Version=17.2.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title><% = ElectronicSubmission.FieldNames.getFieldName("LogFile-Title", "ECMS - Log File") %></title>
    <script>
...
&nbsp;&nbsp;&nbsp; }" />
                    ...
                    <asp:EntityDataSource ID="LogFileDataSource" runat="server" ConnectionString="name=REU_RegistrationEntities" DefaultContainerName="REU_RegistrationEntities" EnableFlattening="False" EntitySetName="Log_File" EntityTypeFilter="Log_File" Select="">
                    </asp:EntityDataSource>
                    <asp:EntityDataSource ID="LogFileDataSourceDetails" runat="server" ConnectionString="name=REU_RegistrationEntities" DefaultContainerName="REU_RegistrationEntities" EnableFlattening="False" EntitySetName="Log_File" EntityTypeFilter="Log_File" Select="" Where="it.Log_Id = @Log_ID_value">
                        <WhereParameters>
                            <asp:SessionParameter DefaultValue="0" Name="Log_ID_value" SessionField="LogID" Type="Int32" />
                        </WhereParameters>
                    </asp:EntityDataSource>
                    <asp:EntityDataSource ID="EmployeeDataSource" runat="server" ConnectionString="name=REU_RegistrationEntities" DefaultContainerName="REU_RegistrationEntities" EntitySetName="Employees" EntityTypeFilter="Employee" AutoGenerateOrderByClause="False" AutoGenerateWhereClause="False" EnableDelete="True" EnableInsert="True" EnableUpdate="True">
                    </asp:EntityDataSource>
