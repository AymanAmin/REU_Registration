           ...
           /* try
            {
                ...
                yourHTMLstring += "<li>" +
                                    "<h6>" + ElectronicSubmission.FieldNames.getFieldName("Master-Notifications", "Notifications") + "</h6>";
                if (notificationMaster.Count > 0)
                {
                    yourHTMLstring += "<label class='label label-danger'>" + ElectronicSubmission.FieldNames.getFieldName("Master-New", "New") + "</label>";
                } 
                yourHTMLstring += "</li>";
                panelNotification.Controls.Add(new LiteralControl(yourHTMLstring));
